...
# import os,sys
# PROJECT_ROOT = '/home/ycl/Desktop/imoocc_py3_online'
...
if __name__ == '__main__':
    ...
    resource = {
                    "dynamic_host": {
                        "hosts": [
                                    {'username': u'root', 'password': 'admin', 'ip': '192.168.153.138','hostname':'ubuntu','port':'22'},
    ...
    # Ansible Adhoc
    rbt.run_model(host_list=['192.168.153.138'],module_name='shell',module_arge="ls /tmp")
