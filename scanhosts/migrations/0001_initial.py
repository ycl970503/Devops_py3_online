    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ssh_passwd', models.CharField(default='', max_length=64, null=True, verbose_name='ssh登录的密码')),
                ('ssh_rsa', models.CharField(default='', max_length=64, null=True, verbose_name='登录使用的私钥')),
                ('rsa_pass', models.CharField(default='', max_length=64, null=True, verbose_name='私钥的秘钥')),
