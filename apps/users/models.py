...
class UserInfo(models.Model):
    ...
    user_level = models.CharField(default='0', max_length=2, choices=STATUS_CHIOCE,verbose_name=u'用户权限等级')
    user_email = models.CharField(max_length=40, verbose_name=u'邮箱地址')
