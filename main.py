...
def main():
    ...
    d_ports = s_conf['dockerinfo']['docker_ports']
   ...
   #扫描主机信息
    ...
    #扫描网络信息
    nm = NmapNet(n_sysname_oid,n_commu)

    #无法通过密钥登录的设备(key_not_login_list)
   ...
   #更新宿主机类型中表对应关系
    ...
    ds = NmapDocker(s_cmds,d_pass,ip_key_dic,d_ports)
